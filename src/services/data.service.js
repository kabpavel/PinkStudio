...
const gData =[{
    ...
    },
    {
        ...
        title: "המורה",
        title2: "המורה",
        // description1: "הכירו את יפעת גולן מייסדת pink studio זמר\contact-usת ומורה  מוסמכת לפיתוח קול בעלת תואר ראשון ותעודת הוראה במוזיקה רב תחומית.",
        ...
        description2:["רוצים ללמוד לשיר ?",
        "שמי יפעת  מורה לפיתוח קול, ושירה בוגרת האקדמיה ובעלת תעודת הוראה ממשרד החינוך",
        "הלימודים בסטודיו כוללים :",
        "🎼🎙️ לימוד בכל הרמות והגילאים.",
        "🎙️🎼 סביבת לימוד נעימה ביתית ותומכת באולפן." ,
        "🎼🎙️התאמת תכנית אישית לכל תלמיד/ה.",
        "🎙️🎼מתן כלים לפיתוח בהמשך הדרך.",
        "🎼🎙️ חשיפה לסגנונות מוזיקליים רבים ומציאת הקול האישי הייחודי לך.", 
        "⭐🎤⭐יפעת גולן זמרת ומורה מוסמכת ומנוסה לפיתוח קול בעלת תואר ראשון במוזיקה רב תחומית בוגרת הקריה האקדמית אונו ותעודת הוראה ממכללת וושינגטון בעלת ניסיון משנת 2016. מורה למוזיקה בבתי ספר יסודיים במשרד החינוך ומתמחה במחזות זמר בוגרת מחזות זמר ביה\"ס ענת ברזילי בעלת תעודה להוראת פיתוח קול - סטודיו ארמת ארנהיים ווקולוגית ומורה לפיתוח קול. לפרטים נוספים, צרו קשר עכשיו  0523573983"
        ],
        back_ground_img1: "",
        img1Url: "teacher_img1.png",
        isInfoList: true,
    ...
    },
    {
        ...
        description2:["הסטודיו נוסד על ידי יפעת גולן זמרת ומורה מוסמכת לפיתוח קול",
        "הסטודיו ממוקם בפרדס חנה יפה נוף",
        "שיעורי פיתוח הקול - הם למתחילים ולמתקדמים ומתאימים לכל הרמות",
        "חוגי המוזיקה לקטנטנים - התכנית מיועדת לילדים בגיל הרך מגיל 3-6",
        "השיעורים באווירה קסומה",
        "לתיאום צרו קשר בטלפון: 0523573983"],
        back_ground_img1: "",
    ...
    },
    {
        ...
        description2:["מטרת הקורס היא להכשיר זמרים או חובבי שירה להיות הכוכבים הבאים, כאלה שהשירה באה מהנשמה. ",
        "בקורס לומדים להבין, לראות, לשמוע ולהרגיש את התלמיד, כדי להגיע לרמה גבוהה של תמיכה וקידום לכל אחד מגיע לשיר מהלב.",
        "",
        "בייבי וייס - קורס לזמרים מתחילים",
        "בשיעורי פיתוח הקול נלמד:",
        "כיצד לשלוט במיתרי הקול ולפתח יציבות קולית.",
        "תרגילי נשימה, הולכת אויר וחיזוק הסרעפת.",
        "הגייה נכונה, תמיכה, דיקציה.",
        "פיתוח שמיעה, קצב והרחבת המנעד הקולי.",
        "מאיפה שרים ומבנה מנגנון הקול.",
        "סולפג', הרמוניה קולית, הבעה אישית.",
        "הלחנה ובניית משפטים מוזיקליים.",
        "כיצד להגיש את השיר.",
        "השיעורים מלווים בתאוריה וקריאת תווים.",
        "משך השיעור 45 או 60 דקות.",
        "שיעור היכרות ראשון  בעלות מוזלת.",
        "",
        "סופר סטאר - קורס לזמרים מתקדמים",
        "בשיעורי פיתוח הקול נלמד על:",
        "תרגילי נשימה",
        "חיזוק הסרעפת",
        "פיתוח יציבות קולית",
        "פיתוח שמיעה וקצב",
        ...
        "הלחנה ובניית משפטים מוזיקליים",
        "כיצד להגיש את השיר",
        "יצירת סגנון וביטוי אישי",
        "השיעורים מלווים בתאוריה וקריאת תווים",
         "משך השיעור 45 או 50 דקות",
        "שיעור היכרות ראשון בעלות מוזלת",
        "לפרטים נוספים צרו קשר עכשיו-🤳🏽0523573983"
        ],
        back_ground_img1: "",
    ...
    },
    {
        ...
        description1:[ "בואו להעניק לילדיכם מסע מוזיקלי בלתי נשכח ולסייע להם לגלות את עולם המוזיקה ." ],
        // description2: `רוצים להעניק מתנה 🎁 לכם, לבן או לבת שלכם? 
        // חוגי מוזיקה לגיל הרך 🎼🎹🎤
        //  שמי יפעת גולן מורה לפיתוח קול, ושירה בוגרת האקדמיה ובעלת תעודת הוראה ממשרד החינוך. 🎙️
        // פיתוח ביטחון עצמי 🎼🎁🎙️
        // יכולת עמידה מול קהל 🎼🎙️
        // סביבת לימוד נעימה 🎼🎙️
        // ארגז כלים לפיתוח אישי לילדכם. 🎼🎙️
        //  חשיפה לסגנונות מוזיקלים רבים 🎼
        ...
        "סביבת לימוד נעימה 🎼🎙️",
        "ארגז כלים לפיתוח אישי לילדכם. 🎼🎙️",
        "חשיפה לסגנונות מוזיקלים רבים 🎼🎙️",
        "מחפשים חוויה בלעדית לילדכם הגעתם למקום הנכון 🎼🎙️",
        "לפרטים נוספים צרו קשר עכשיו 🤳🏽",
        "",
        "יפעת 0523573983"],
        back_ground_img1: "",
    ...
    },
    {
        ...
        description2:["לא כדאי לכם לפספס הופעה מדהימה ונוצצת של זמרת ופסנתרן",
        "חוויה מיוחדת, מסעירה ומרתקת..",
        "הופעה שעדיין לא נראתה בישראל.",
        "הופעה ייחודית של שירים וניחוח של ספרד עם שירי לאדינו.."],
        back_ground_img1: "",
    ...
    },
    {
        ...
        description2:["לא כדאי לכם לפספס למיטב שירי הדיסני האהובים ביותר בכל הזמנים",
        "הופעה מדהימה ונוצצת של זמרת ופסנתרן",
        "חוויה מיוחדת, מסעירה ומרתקת..",
        "הופעה שעדיין לא נראתה בישראל.",
        "הופעה ייחודית של שירים עם נגיעה של טעם הילדות - שירי דיסני המיוחדים"],
        back_ground_img1: "",
    ...
    },   
    {
        ...
        description1:["\"פינק סטודיו\" - סטודיו לפיתוח קול ומוזיקה  הממוקם בפרדס חנה יפה נוף.",
        "לפרטים נוספים צרו קשר עכשיו - 0523573983"],
        // description2: "\"פינק סטודיו\" - סטודיו לפיתוח קול ומוזיקה  הממוקם בפרדס חנה יפה נוף. לפרטים נוספים צרו קשר עכשיו - 0523573983",
        description2:["\"פינק סטודיו\" - סטודיו לפיתוח קול ומוזיקה  הממוקם בפרדס חנה יפה נוף.",
        "לפרטים נוספים צרו קשר עכשיו - 0523573983"],
